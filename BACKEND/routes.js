...
routes.post("/post/bottles", BottleController.saveBottles);
routes.post(
  "/post/deliveryOrder",
  DeliveryOrderController.createNewDeliveryOrder
);
routes.get("/get/deliveryOrders", DeliveryOrderController.loadDeliveryOrders);
routes.post("/post/end_order", DeliveryOrderController.endOrder);
routes.post("/post/cancel_order", DeliveryOrderController.cancelOrder);
